    ...
    children: [
      {
        ...
        meta: { title: "未读消息", icon: "icon-danrenyi", menuId: 201 },
      },
      {
        path: "readedMessage",
        name: "ReadedMessage",
        component: ReadedMessage,
        meta: { title: "已读消息", icon: "icon-kongtiao", menuId: 202 },
      },
      {
        path: "totalMessage",
        name: "TotalMessage",
        component: TotalMessage,
        meta: { title: "全部消息", icon: "icon-xiyiji", menuId: 203 },
      },
    ],
  },
